...
namespace Microsoft.Samples.Kinect.ControlsBasics
{
    ...
    public partial class MainWindow
    {
        ...
        private void KinectTileButtonClick(object sender, RoutedEventArgs e)
        {
            ...
            else if (button.Label == "Search Rules")
            {
                label1.Content = "Searched Rules";
            }
            
            //=====================================================================================
            //
            //
            //Here is where we can stat calling the scripts and stuffs
            //
            //
            //=====================================================================================
        }
        ...
        private void KinectTileButtonClickMe(object sender, RoutedEventArgs e)
        {
            var button = (KinectTileButton)e.OriginalSource;
            //var selectionDisplay = new SelectionDisplay(button.Label as string);
            //this.kinectRegionGrid.Children.Add(selectionDisplay);
        ...
        void RunScript()
        {
            ...
            string output = System.IO.File.ReadAllText(@"output.txt"); // todo: fix this hardcoded stuff
            MessageBox.Show(output); // todo: redirect output somewhere else
        }

    } // end class MainWindow

} // end namespace Microsoft.Samples.Kinect.ControlsBasics
